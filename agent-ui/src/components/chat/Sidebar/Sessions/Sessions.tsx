...
const Sessions = () => {
  ...
  if (isSessionsLoading || isEndpointLoading) {
    return (
      <div className="w-full">
        <div className="mb-3 text-xs font-bold uppercase tracking-wider text-primary/80">Sessions</div>
        <div className="mt-4 h-[calc(100vh-325px)] w-full space-y-2 overflow-y-auto">
  ...
  return (
    <div className="w-full">
      <div className="mb-3 w-full text-xs font-bold uppercase tracking-wider text-primary/80">Sessions</div>
      <div
        className={`h-[calc(100vh-345px)] overflow-y-auto font-geist transition-all duration-300 [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar]:transition-opacity [&::-webkit-scrollbar]:duration-300 ${
          isScrolling
            ? '[&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-accent/60 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar]:opacity-100'
